...
Console.WriteLine($"\n add massive m x n and add range:");
int m = InputNumbers("add m: ");
int n = InputNumbers("add n: ");
int range = InputNumbers("add range:  1 to ");
...
Console.WriteLine($"\n add size massive m x n and add range:");
int m = InputNumbers("add m: ");
int n = InputNumbers("add n: ");
int range = InputNumbers("add range: от 1 до ");
...
Console.WriteLine($"\n{minSumLine+1} - small sum ({sumLine}) elems ");
